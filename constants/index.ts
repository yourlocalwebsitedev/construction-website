...
export const INITIAL_SERVICES: Service[] = [
  ...
  // ==================================================
  {
    ...
    assemblySummary: {
      en: "Scratch Coat → Brown Coat → Finish Coat",
      es: "Capa Rasqueteada → Capa Base → Capa de Acabado",
    },
    processSteps: [
      {
        title: {
          en: "1. Substrate Preparation",
          es: "1. Preparación del Sustrato",
        },
        description: {
    ...
    problems: [
      {
        en: "Cracked or crumbling plaster",
        es: "Yeso agrietado o desmoronado",
      },
      {
        en: "Water-damaged walls or ceilings",
        es: "Paredes o techos dañados por agua",
      },
      {
        en: "Loose or bulging plaster sections",
        es: "Secciones de yeso sueltas o abultadas",
      },
    ],
    benefits: [
      {
        en: "Seamless, invisible repairs",
        es: "Reparaciones perfectas e invisibles",
      },
      {
        en: "Matched textures and finishes",
        es: "Texturas y acabados igualados",
      },
      {
        en: "Durable, professionally built-up wall system",
        es: "Sistema de pared duradero y construido profesionalmente",
      },
    ],
    faqs: [
      {
        question: {
          en: "How long does plaster repair take?",
          es: "¿Cuánto tarda la reparación de yeso?",
        },
        answer: {
          en: "Most repairs are completed within 1-3 days depending on size and drying time.",
          es: "La mayoría de las reparaciones se completan en 1-3 días según el tamaño y el tiempo de secado.",
        },
      },
    ],
  },
  ...
  },
  {
    ...
    problems: [
      {
        en: "Water stains and leak damage",
        es: "Manchas de agua y daños por fugas",
      },
      {
        en: "Sagging or bulging ceiling sections",
        es: "Secciones de techo hundidas o abultadas",
      },
      {
        en: "Cracking near seams and corners",
        es: "Grietas cerca de uniones y esquinas",
      },
    ],
    benefits: [
      {
        en: "Restored structural integrity",
        es: "Integridad estructural restaurada",
      },
      {
        en: "Smooth, paint-ready surface",
        es: "Superficie lisa lista para pintar",
      },
    ],
    faqs: [],
  },
  {
    ...
    parentSlug: "plastering",
    title: {
      en: "Drywall Repair & Finishing",
      es: "Reparación y Acabado de Drywall",
    },
    shortDescription: {
    ...
    problems: [
      {
        en: "Holes, dents and nail pops",
        es: "Agujeros, abolladuras y clavos salidos",
      },
  ...
  },
  {
    ...
    problems: [
      {
        en: "Outdated or rough wall texture",
        es: "Textura de pared anticuada o rugosa",
      },
      {
        en: "Multiple patch marks and inconsistencies",
        es: "Múltiples marcas de parches e inconsistencias",
      },
    ],
    benefits: [
      {
        en: "Modern, smooth wall finish",
        es: "Acabado de pared moderno y liso",
      },
      {
        en: "Even surface for paint or wallpaper",
        es: "Superficie uniforme para pintura o papel tapiz",
      },
    ],
    faqs: [],
  },
  {
    ...
    parentSlug: "plastering",
    title: {
      en: "Popcorn Ceiling Removal",
      es: "Eliminación de Techo de Palomitas",
    },
    shortDescription: {
    ...
    problems: [
      ...
      {
        en: "Difficulty cleaning textured ceilings",
        es: "Dificultad para limpiar techos texturizados",
      },
    ],
    benefits: [
      {
        en: "Clean, modern smooth ceilings",
        es: "Techos lisos, limpios y modernos",
      },
  ...
  },
  {
    ...
    parentSlug: "plastering",
    title: {
      en: "Wall & Ceiling Restoration",
      es: "Restauración de Paredes y Techos",
    },
    shortDescription: {
    ...
    problems: [
      ...
      {
        en: "Multiple layers of past repairs",
        es: "Múltiples capas de reparaciones pasadas",
      },
    ],
    benefits: [
      {
        en: "Preserves character while modernizing",
        es: "Conserva el carácter mientras moderniza",
      },
      {
        en: "Long-term structural stability",
        es: "Estabilidad estructural a largo plazo",
      },
    ],
    faqs: [],
  },
  ...
  // ==================================================
  {
    ...
    assemblySummary: {
      en: "WRB → Lath → Scratch Coat → Brown Coat → Finish Coat",
      es: "BRA → Lath → Capa Rasqueteada → Capa Base → Capa de Acabado",
    },
    processSteps: [
      {
        title: {
          en: "Water-Resistive Barrier / Drainage",
          es: "Barrera Resistente al Agua / Drenaje",
        },
        description: {
    ...
    problems: [
      {
        en: "Cracked, stained or damaged stucco",
        es: "Estuco agrietado, manchado o dañado",
      },
      {
        en: "Poor drainage behind the stucco assembly",
        es: "Drenaje deficiente detrás del conjunto de estuco",
      },
      {
        en: "Failed transitions at windows, doors and penetrations",
        es: "Transiciones fallidas en ventanas, puertas y penetraciones",
      },
    ],
    benefits: [
      {
        en: "Attention to the full wall assembly, not just the finish",
        es: "Atención al conjunto completo de la pared, no solo al acabado",
      },
      {
        en: "Durable exterior cladding built to last",
        es: "Revestimiento exterior duradero hecho para durar",
      },
      {
        en: "Range of textures and finishes available",
        es: "Variedad de texturas y acabados disponibles",
      },
    ],
    faqs: [
      {
        question: {
          en: "Does stucco waterproof my home by itself?",
          es: "¿El estuco impermeabiliza mi casa por sí solo?",
        },
        answer: {
          en: "No. Stucco is an exterior cladding and finish system — the water-resistive barrier and drainage plane behind it are what actually manage water. We install and detail both correctly as part of every stucco project.",
          es: "No. El estuco es un sistema de revestimiento y acabado exterior — la barrera resistente al agua y el plano de drenaje detrás de él son los que realmente manejan el agua. Instalamos y detallamos ambos correctamente en cada proyecto.",
        },
      },
    ],
  },
  ...
  // ==================================================
  {
    ...
    title: {
      en: "EIFS",
      es: "EIFS (Sistema de Aislamiento y Acabado Exterior)",
    },
    shortDescription: {
    ...
    assemblySummary: {
      en: "Air/Water Control → EPS Insulation → Base Coat → Reinforcing Mesh → Finish Coat",
      es: "Control de Aire/Agua → Aislamiento EPS → Capa Base → Malla de Refuerzo → Capa de Acabado",
    },
    processSteps: [
      {
      ...
      {
        title: {
          en: "2. Air/Water Control Layer",
          es: "2. Capa de Control de Aire/Agua",
        },
        description: {
      ...
      {
        title: {
          en: "3. Insulation Installation",
          es: "3. Instalación del Aislamiento",
        },
        description: {
    ...
    problems: [
      {
        en: "Cracked or damaged EIFS finish",
        es: "Acabado de EIFS agrietado o dañado",
      },
      {
        en: "Poor insulation continuity or thermal bridging",
        es: "Continuidad deficiente del aislamiento o puentes térmicos",
      },
      {
        en: "Failed transitions at windows, doors and roof lines",
        es: "Transiciones fallidas en ventanas, puertas y líneas de techo",
      },
    ],
    benefits: [
      {
        en: "Continuous exterior insulation for better envelope performance",
        es: "Aislamiento exterior continuo para mejor desempeño de la envolvente",
      },
      {
        en: "Reinforced, durable base and finish system",
        es: "Sistema base y de acabado reforzado y duradero",
      },
      {
        en: "Wide range of architectural finish options",
        es: "Amplia gama de opciones de acabado arquitectónico",
      },
    ],
    faqs: [],
  },
  ...
  // ==================================================
  {
    ...
    isPillar: true,
    title: {
      en: "Air Barrier & Waterproofing",
      es: "Barrera de Aire e Impermeabilización",
    },
    shortDescription: {
    ...
    assemblySummary: {
      en: "Substrate → Detailing → Membrane → Cladding",
      es: "Sustrato → Detallado → Membrana → Revestimiento",
    },
    processSteps: [
      {
        title: {
      ...
      {
        title: {
          en: "2. Joints and Transitions",
          es: "2. Juntas y Transiciones",
        },
        description: {
      ...
      {
        title: {
          en: "4. Main Air/Water Barrier",
          es: "4. Barrera Principal de Aire/Agua",
        },
        description: {
      ...
      {
        title: {
          en: "6. Protection / Cladding",
          es: "6. Protección / Revestimiento",
        },
        description: {
    ...
    problems: [
      {
        en: "Water intrusion through the wall assembly",
        es: "Intrusión de agua a través del conjunto de pared",
      },
      {
        en: "Poorly detailed windows, doors or penetrations",
        es: "Ventanas, puertas o penetraciones mal detalladas",
      },
      {
        en: "Missing or failed air/water control layer",
        es: "Capa de control de aire/agua faltante o fallida",
      },
    ],
    benefits: [
      {
        en: "Protects the long-term performance of the building envelope",
        es: "Protege el desempeño a largo plazo de la envolvente del edificio",
      },
      {
        en: "Careful detailing at the most vulnerable transitions",
        es: "Detallado cuidadoso en las transiciones más vulnerables",
      },
      {
        en: "Compatible integration with stucco, EIFS or other cladding",
        es: "Integración compatible con estuco, EIFS u otro revestimiento",
      },
    ],
    faqs: [],
  },
...
export const BEFORE_AFTER_ITEMS: BeforeAfterItem[] = [
  {
    id: "ba1",
    title: {
      en: "Ceiling Water Damage Repair",
      es: "Reparación de Daño de Agua en Techo",
    },
  ...
  },
  {
    id: "ba2",
    title: {
      en: "Living Room Plaster Restoration",
      es: "Restauración de Yeso en Sala",
    },
  ...
  },
  {
    id: "ba5",
    title: {
      en: "Historic Home Restoration",
      es: "Restauración de Casa Histórica",
    },
  ...
  },
  {
    id: "ba6",
    title: {
      en: "Textured Wall Skim Coat",
      es: "Enlucido de Pared Texturizada",
    },
...
export const INITIAL_PROJECTS: Project[] = [
  {
    ...
    location: "Residential Home",
    services: [
      { en: "Plaster Repair", es: "Reparación de Yeso" },
      { en: "Ceiling Repair", es: "Reparación de Techos" },
    ],
  },
  {
    id: "p2",
    ...
    location: "Residential Home",
    services: [
      { en: "Skim Coating", es: "Enlucido" },
      { en: "Drywall Repair & Finishing", es: "Acabado de Drywall" },
    ],
  },
  {
    id: "p3",
    ...
    services: [
      { en: "Popcorn Ceiling Removal", es: "Eliminación de Palomitas" },
    ],
  },
];
...
export const TRANSLATIONS = {
  [Language.EN]: {
    ...
    home: {
      ...
      heroSubtitle:
        "Expert plastering, stucco, EIFS and air/water barrier work — built on proper substrate preparation, not just the visible finish.",
      ...
      trust: {
        ...
        rating: "Trusted Subcontractor",
        ratingSub: "Working with Scott's Quality Plaster & Stucco",
        craftsmanship: "Quality Craftsmanship",
        service: "Professional Service",
        freeEstimates: "Reliable Project Delivery",
      },
      moreThanFinish: {
      ...
      finalCta: {
        ...
        subtitle:
          "Tell us about your project and send us a few photos to get started.",
    ...
    estimate: {
      ...
      descriptionPlaceholder:
        "Describe the issue, size of area, materials, timeline...",
      ...
      step5Sub:
        "We'll reach out to confirm details and schedule your estimate.",
      name: "Full Name",
      phone: "Phone Number",
      email: "Email Address",
      ...
      successBody:
        "A member of K & L Pro-Finish Plastering LLC will contact you regarding your project.",
    ...
    about: {
      ...
      storyText:
        "K&L Pro-Finish Plastering LLC was founded on a simple idea: deliver plastering and finishing work that looks flawless and lasts. From small repairs to full interior restorations, we bring craftsmanship and care to every project, treating every home like our own.",
      missionTitle: "Our Mission",
      missionText:
        "To deliver exceptional plastering and finishing work that exceeds client expectations, with honest communication, clean job sites, and results our customers are proud to show off.",
      craftsmanshipTitle: "Craftsmanship",
      craftsmanshipText:
        "Every crack, seam, and surface is treated with the same attention to detail — because the difference is in the details.",
      teamTitle: "Our Team",
      teamText:
        "A dedicated crew of finishing professionals focused on quality workmanship and respectful, reliable service.",
      serviceAreaTitle: "Service Area",
      values: {
        quality: {
          title: "Quality",
          desc: "We never compromise on materials or workmanship.",
        },
        integrity: {
          title: "Integrity",
          desc: "Honest pricing, transparent timelines, and no hidden fees.",
        },
        safety: {
          title: "Care",
          desc: "Careful protection of your home and belongings on every job.",
        },
        innovation: {
          title: "Craftsmanship",
          desc: "Time-tested techniques paired with modern materials.",
        },
      },
      stats: {
        years: "Trusted",
  ...
  [Language.ES]: {
    ...
    home: {
      ...
      heroSubtitle:
        "Yeso, estuco, EIFS y barreras de aire/agua expertos — construidos sobre una preparación adecuada del sustrato, no solo el acabado visible.",
      ...
      trust: {
        ...
        rating: "Subcontratista de Confianza",
        ratingSub: "Trabajando con Scott's Quality Plaster & Stucco",
      ...
      moreThanFinish: {
        ...
        diagram: [
          "SUSTRATO",
          "CONTROL DE AIRE/AGUA",
          "REFUERZO / AISLAMIENTO",
          "CAPAS BASE",
          "ACABADO",
        ],
      },
      ...
      finalCta: {
        ...
        subtitle:
          "Cuéntanos sobre tu proyecto y envíanos algunas fotos para comenzar.",
    ...
    services: {
      ...
      getEstimateCta:
        "¿Tienes un proyecto similar? Obtén un presupuesto gratis.",
    },
    admin: {
    ...
    estimate: {
      ...
      descriptionPlaceholder:
        "Describe el problema, tamaño del área, materiales, cronograma...",
      ...
      step5Sub:
        "Nos comunicaremos para confirmar detalles y programar tu presupuesto.",
      ...
      successBody:
        "Un miembro de K & L Pro-Finish Plastering LLC se pondrá en contacto contigo sobre tu proyecto.",
    ...
    contact: {
      ...
      subtitle:
        "Cuéntenos sobre su proyecto. Respondemos generalmente en 2 horas.",
      phone: "Teléfono",
      text: "Mensaje",
      whatsapp: "WhatsApp",
      email: "Correo",
    ...
    about: {
      ...
      storyText:
        "K&L Pro-Finish Plastering LLC se fundó con una idea simple: entregar trabajos de yeso y acabados que se vean impecables y duren. Desde pequeñas reparaciones hasta restauraciones interiores completas, aportamos artesanía y cuidado a cada proyecto.",
      missionTitle: "Nuestra Misión",
      missionText:
        "Ofrecer un trabajo de yeso y acabados excepcional que supere las expectativas del cliente, con comunicación honesta, sitios de trabajo limpios y resultados de los que nuestros clientes se sientan orgullosos.",
      craftsmanshipTitle: "Artesanía",
      craftsmanshipText:
        "Cada grieta, unión y superficie se trata con la misma atención al detalle, porque la diferencia está en los detalles.",
      teamTitle: "Nuestro Equipo",
      teamText:
        "Un equipo dedicado de profesionales de acabados enfocados en la calidad del trabajo y un servicio confiable.",
      serviceAreaTitle: "Área de Servicio",
      values: {
        quality: {
          title: "Calidad",
          desc: "Nunca comprometemos los materiales o la mano de obra.",
        },
        integrity: {
          title: "Integridad",
          desc: "Precios honestos, plazos transparentes y sin cargos ocultos.",
        },
        safety: {
          title: "Cuidado",
          desc: "Protección cuidadosa de su hogar y pertenencias en cada trabajo.",
        },
        innovation: {
          title: "Artesanía",
          desc: "Técnicas probadas combinadas con materiales modernos.",
        },
      },
      stats: {
        years: "Confiable",
